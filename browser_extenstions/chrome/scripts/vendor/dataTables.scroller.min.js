...
$jscomp.findInternal = function (c, f, g) {
  ...
  for (var h = c.length, k = 0; k < h; k++) {
    var m = c[k];
    if (f.call(g, m, k, c)) return { i: k, v: m };
  }
  return { i: -1, v: void 0 };
};
$jscomp.ASSUME_ES5 = !1;
...
$jscomp.polyfill = function (c, f, g, h) {
  f && ($jscomp.ISOLATE_POLYFILLS ? $jscomp.polyfillIsolated(c, f, g, h) : $jscomp.polyfillUnisolated(c, f, g, h));
};
$jscomp.polyfillUnisolated = function (c, f, g, h) {
  ...
  h = g[c];
  f = f(h);
  f != h && null != f && $jscomp.defineProperty(g, c, { configurable: !0, writable: !0, value: f });
};
$jscomp.polyfillIsolated = function (c, f, g, h) {
  ...
  null != f &&
    (c
      ? $jscomp.defineProperty($jscomp.polyfills, k, { configurable: !0, writable: !0, value: f })
      : f !== g &&
        (($jscomp.propertyToPolyfillSymbol[k] = $jscomp.IS_SYMBOL_NATIVE
          ? $jscomp.global.Symbol(k)
          : $jscomp.POLYFILL_PREFIX + k),
        (k = $jscomp.propertyToPolyfillSymbol[k]),
        $jscomp.defineProperty(h, k, { configurable: !0, writable: !0, value: f })));
};
$jscomp.polyfill(
...
(function (c) {
  ...
  c.extend(m.prototype, {
    measure: function (a) {
      ...
      b.row &&
        ((b.viewport = this._parseHeight(c(this.dom.scroller).css('max-height'))),
    ...
    pixelsToRow: function (a, b, d) {
      ...
      d = d
        ? (this._domain('physicalToVirtual', this.s.baseScrollTop) + a) / this.s.heights.row
    ...
    scrollToRow: function (a, b) {
      ...
      (l > this.s.redrawBottom || l < this.s.redrawTop) &&
        ...
        ((e = !0),
        (l = this._domain('virtualToPhysical', a * this.s.heights.row)),
        this.s.redrawTop < l && l < this.s.redrawBottom && ((this.s.forceReposition = !0), (b = !1)));
      b === h || b
        ? ((this.s.ani = e),
          c(this.dom.scroller).animate({ scrollTop: l }, function () {
            setTimeout(function () {
              d.s.ani = !1;
            }, 250);
          }))
        : c(this.dom.scroller).scrollTop(l);
    },
    construct: function () {
      var a = this,
        b = this.s.dtApi;
      if (this.s.dt.oFeatures.bPaginate) {
        ...
        c(this.dom.scroller).on('scroll.dt-scroller', function (l) {
          a._scroll.call(a);
        });
    ...
    _calcRowHeight: function () {
      ...
      c('div.' + a.oClasses.sScrollBody, l).append(d);
    ...
    _draw: function () {
      ...
      var r = d - (this.s.topRowFloat - l) * b.row;
      ...
      this.s.redrawBottom = d + e > b.scroll - b.viewport - b.row ? b.scroll - b.viewport - b.row : d + e;
      this.s.skip = !1;
      this.s.dt.oFeatures.bStateSave &&
      null !== this.s.dt.oLoadedState &&
      'undefined' != typeof this.s.dt.oLoadedState.scroller
        ? (((b = (!this.s.dt.sAjaxSource && !a.s.dt.ajax) || this.s.dt.oFeatures.bServerSide ? !1 : !0) &&
            2 == this.s.dt.iDraw) ||
            (!b && 1 == this.s.dt.iDraw)) &&
          setTimeout(function () {
      ...
      if (this.s.dt.oFeatures.bInfo) {
        ...
        p =
          0 === a.fnRecordsDisplay() && a.fnRecordsDisplay() == a.fnRecordsTotal()
            ...
            ? b.sInfoEmpty + ' ' + b.sInfoFiltered.replace('_MAX_', t) + b.sInfoPostFix
            : a.fnRecordsDisplay() == a.fnRecordsTotal()
            ? b.sInfo.replace('_START_', p).replace('_END_', r).replace('_MAX_', t).replace('_TOTAL_', u) +
              b.sInfoPostFix
            : b.sInfo.replace('_START_', p).replace('_END_', r).replace('_MAX_', t).replace('_TOTAL_', u) +
              ' ' +
              b.sInfoFiltered.replace('_MAX_', a.fnFormatNumber(a.fnRecordsTotal())) +
              b.sInfoPostFix;
        (b = b.fnInfoCallback) && (p = b.call(a.oInstance, a, e, d, l, n, p));
        e = a.aanFeatures.i;
        if ('undefined' != typeof e) for (l = 0, n = e.length; l < n; l++) c(e[l]).html(p);
    ...
    _scroll: function () {
      ...
      if (!this.s.skip && !this.s.ingnoreScroll && d !== this.s.lastScrollTop)
        if (this.s.dt.bFiltered || this.s.dt.bSorted) this.s.lastScrollTop = 0;
          ...
          this.s.topRowFloat =
            'cont' === this.s.scrollType ? this.pixelsToRow(d, !1, !1) : this._domain('physicalToVirtual', d) / b.row;
          ...
          if (this.s.forceReposition || d < this.s.redrawTop || d > this.s.redrawBottom) {
            ...
            0 >= e
              ...
              ? ((e = this.s.dt.fnRecordsDisplay() - this.s.dt._iDisplayLength), 0 > e && (e = 0))
              : 0 !== e % 2 && e++;
            this.s.targetTop = e;
  ...
  m.defaults = { boundaryScale: 0.5, displayBuffer: 9, loadingIndicator: !1, rowHeight: 'auto', serverWait: 200 };
  m.oDefaults = m.defaults;
  m.version = '2.0.5';
  c(g).on('preInit.dt.dtscroller', function (a, b) {
    if ('dt' === a.namespace) {
      a = b.oInit.scroller;
      var d = k.defaults.scroller;
  ...
  q.register('row().scrollTo()', function (a) {
    ...
    this.iterator('row', function (d, e) {
      d.oScroller &&
        ((e = b.rows({ order: 'applied', search: 'applied' }).indexes().indexOf(e)), d.oScroller.scrollToRow(e, a));
    });
    return this;
  });
