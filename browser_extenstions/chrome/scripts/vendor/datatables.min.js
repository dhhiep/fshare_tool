...
(function (l) {
  ...
  function E(a) {
    ...
    l.each(a, function (e, h) {
      (b = e.match(/^([^A-Z]+?)([A-Z])/)) &&
        ...
        ((c = e.replace(b[0], b[2].toLowerCase())), (d[c] = e), 'o' === b[1] && E(a[e]));
    });
    a._hungarianMap = d;
  }
  function P(a, b, c) {
    ...
    l.each(b, function (e, h) {
      ...
      d === q ||
        (!c && b[d] !== q) ||
        ('o' === d.charAt(0) ? (b[d] || (b[d] = {}), l.extend(!0, b[d], b[e]), P(a[d], b[d], c)) : (b[d] = b[e]));
    });
  }
  function ma(a) {
        ...
        a.iDrawError != e &&
          ...
          (da(
            ...
            'Requested unknown parameter ' +
              ('function' == typeof h.mData ? '{function}' : "'" + h.mData + "'") +
              ' for row ' +
              b +
              ', column ' +
              c,
      ...
      t = function (x) {
        if (c === q || c === g)
          (f = m[g]),
            (k = x.innerHTML.trim()),
            f && f._bAttrSrc
              ? (ha(f.mData._)(d, k), p(f.mData.sort, x), p(f.mData.type, x), p(f.mData.filter, x))
              : n
  ...
  function Fb(a) {
    ...
    for (b = g.length; k < b; k++) {
      ...
      a.oFeatures.bSort &&
        ...
        !1 !== m.bSortable && (n.attr('tabindex', a.iTabIndex).attr('aria-controls', a.sTableId), eb(a, m.nTh, k)));
  ...
  function ja(a, b) {
    ...
    if (-1 !== l.inArray(!1, c)) V(a, !1);
      ...
      g !== q &&
        -1 !== g &&
        ((a._iDisplayStart = k ? g : g >= a.fnRecordsDisplay() ? 0 : g), (a.iInitDisplayStart = -1));
      g = a._iDisplayStart;
      ...
      if (0 !== m.length)
        ...
        (d = f.sZeroRecords),
          1 == a.iDraw && 'ajax' == Q(a)
            ? (d = f.sLoadingRecords)
            : f.sEmptyTable && 0 === a.fnRecordsTotal() && (d = f.sEmptyTable),
          (c[0] = l('<tr/>', { class: h ? e[0] : '' }).append(
            l('<td />', { valign: 'top', colSpan: oa(a), class: a.oClasses.sRowEmpty }).html(d)
          )[0]);
    ...
    for (var h = a.sDom.split(''), f, g, k, m, n, p, t = 0; t < h.length; t++) {
      ...
      if ('<' == g) {
        ...
        if ("'" == m || '"' == m) {
          ...
          -1 != n.indexOf('.')
            ? ((m = n.split('.')), (k.id = m[0].substr(1, m[0].length - 1)), (k.className = m[1]))
            : '#' == n.charAt(0)
  ...
  function Oa(a, b, c) {
    ...
    m = {
      ...
      error: function (n, p, t) {
        ...
        -1 === l.inArray(!0, t) &&
          ('parsererror' == p ? da(a, 0, 'Invalid JSON response', 1) : 4 === n.readyState && da(a, 0, 'Ajax error', 7));
        V(a, !1);
      },
    };
    a.oAjaxData = b;
  ...
  function Ha(a) {
    ...
    if (a.scrollBarVis !== fa && a.scrollBarVis !== q) (a.scrollBarVis = fa), ta(a);
      ...
      '' === c
        ? ((C.width = '100%'),
          L &&
            (w.find('tbody').height() > g.offsetHeight || 'scroll' == n.css('overflow-y')) &&
    ...
    if (d || (!t && !h && !e && g == oa(a) && g == m.length))
      ...
      for (v = 0; v < k.length; v++)
        (w = c[k[v]]),
          ...
          w.sWidthOrig &&
            h &&
            l(m[v]).append(l('<div/>').css({ width: w.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
      if (a.aoData.length)
        for (v = 0; v < k.length; v++)
      ...
      h && f
        ? g.width(f)
        : h
        ? (g.css('width', 'auto'), g.removeAttr('width'), g.width() < p.clientWidth && n && g.width(p.clientWidth))
        : e
    ...
    for (var d = 0, e = b.length; d < e; d++) {
      ...
      h.bSortable &&
        (0 < c.length && c[0].col == d
          ? (k.setAttribute('aria-sort', 'asc' == c[0].dir ? 'ascending' : 'descending'),
            (h = f[c[0].index + 1] || f[0]))
          : (h = f[0]),
  ...
  function bc(a, b) {
    ...
    for (var h, f = u.ext.type.order[c.sType + '-pre'], g = 0, k = a.aoData.length; g < k; g++)
      if (((c = a.aoData[g]), c._aSortData || (c._aSortData = []), !c._aSortData[b] || d))
  ...
  var u = function (a, b) {
      ...
      this.each(function () {
        ...
        if ('table' != this.nodeName.toLowerCase())
          da(null, 0, 'Non-table node initialisation (' + this.nodeName + ')', 2);
        else {
          zb(p);
          Ab(p.column);
          P(p, p, !0);
  ...
  B.register = y = function (a, b) {
    if (Array.isArray(a)) for (var c = 0, d = a.length; c < d; c++) B.register(a[c], b);
      ...
      for (c = d.length; a < c; a++) {
        ...
        a === c - 1
          ? ((g.val = b), (g.type = 'function' === typeof b ? 'function' : l.isPlainObject(b) ? 'object' : 'other'))
    ...
    Va = function (a, b) {
      ...
      if ('current' == b) for (f = a._iDisplayStart, a = a.fnDisplayEnd(); f < a; f++) c.push(d[f]);
        ...
        for (f = 0, a = a.aoData.length; f < a; f++)
          'none' == h
            ? c.push(f)
            : ((e = l.inArray(f, d)), ((-1 === e && 'removed' == h) || (0 <= e && 'applied' == h)) && c.push(f));
      return c;
    },
    xc = function (a, b, c) {
      var d;
      return ub(
        ...
        function (e) {
          ...
          if ('string' === typeof e && '#' === e.charAt(0) && ((h = a.aIds[e.replace(/^#/, '')]), h !== q))
            return [h.idx];
  ...
  var yc = function (a, b, c, d) {
          ...
          if (Array.isArray(f) || f instanceof l) for (var k = 0, m = f.length; k < m; k++) h(f[k], g);
            ...
            f.nodeName && 'tr' === f.nodeName.toLowerCase()
              ...
              : ((k = l('<tr><td></td></tr>').addClass(g)),
                (l('td', k).addClass(g).html(f)[0].colSpan = oa(a)),
                e.push(k[0]));
        };
      h(c, d);
    ...
    xb = function (a, b) {
      ...
      c.length &&
        ...
        a._details &&
        (a._details.remove(), (a._detailsShow = q), (a._details = q), l(a.nTr).removeClass('dt-hasChild'), qa(c[0]));
    },
    qc = function (a, b) {
      var c = a.context;
        ...
        l(a.nTable).on('order.dt.DT', function (e, h, f, g) {
          a === h &&
            ...
            b
              ...
              .addClass('asc' == g[e] ? d.sSortAsc : 'desc' == g[e] ? d.sSortDesc : c.sSortingClass));
        });
      },
